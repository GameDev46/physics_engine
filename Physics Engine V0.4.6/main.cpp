...
class circleCollider {
    public:
        ...
        void updateBody(float delta) {
            ...
            systemEnergy += mass * gravity * (10000.0f - position.y);
...
int main()
{
    ...
    worldSettingsPanel.position = Vector2({ 96.0f, 290.0f });

    Panel worldInfoPanel;
    worldInfoPanel.position = Vector2({ 143.0f, 20.0f });

    Panel objectCountPanel;
    objectCountPanel.position = Vector2({ 82.5f, 180.0f });
    ...
    while (!WindowShouldClose())
    {
        ...
        BeginMode2D(cam);
            ...
            if (!isHoldingObject && isMouseDown && !worldSettingsPanel.isHovered() && !objectCountPanel.isHovered() && !worldInfoPanel.isHovered()) {
                SetMouseCursor(9);
        ...
        // Panel title
        DrawText("World Info", worldInfoPanel.position.x - 133.0f, worldInfoPanel.position.y, 12, GetColor(0xffffffff) );
        ...
        DrawText(hertzText, worldInfoPanel.position.x - 133.0f, worldInfoPanel.position.y + 80.0f, 12, GetColor(0xffffffff) );

        char fpsText[256];
        snprintf(fpsText, sizeof(fpsText), "FPS: %d ", int( round( 1.0f / GetFrameTime() ) ));
        DrawText(fpsText, worldInfoPanel.position.x - 133.0f, worldInfoPanel.position.y + 100.0f, 12, GetColor(0xffffffff) );
        ...
        // Panel title
        DrawText("Object Count", objectCountPanel.position.x - 72.5f, objectCountPanel.position.y, 12, GetColor(0xffffffff) );
        ...
        // Outline
        rect = { worldSettingsPanel.position.x - 108.0f, worldSettingsPanel.position.y - 14.0f, 204.0f, 321.0f };
        DrawRectangleRounded(rect, 0.05f, 10, GetColor(0x0b101dff));

        // Panel Backing
        rect = { worldSettingsPanel.position.x - 106.0f, worldSettingsPanel.position.y - 12.0f, 200.0f, 317.0f };
        DrawRectangleRounded(rect, 0.05f, 10, GetColor(0x1b202dff));
        ...
        // Panel title
        DrawText("World Settings", worldSettingsPanel.position.x - 86.0f, worldSettingsPanel.position.y, 12, GetColor(0xffffffff) );

        // Inputs

        DrawText("Spawned Spring Constant: ", worldSettingsPanel.position.x - 86.0f, 40.0f + worldSettingsPanel.position.y, 12, GetColor(0xffffffff) );

        defaultSpringConstantInput.position = Vector2( { worldSettingsPanel.position.x - 86.0f, 55.0f + worldSettingsPanel.position.y } );
        ...
        DrawText("World Gravity: ", worldSettingsPanel.position.x - 86.0f, 85.0f + worldSettingsPanel.position.y, 12, GetColor(0xffffffff) );

        worldGravityInput.position = Vector2( { worldSettingsPanel.position.x - 86.0f, 100.0f + worldSettingsPanel.position.y } );
        ...
        DrawText("Spawned Object Mass: ", worldSettingsPanel.position.x - 86.0f, 130.0f + worldSettingsPanel.position.y, 12, GetColor(0xffffffff) );

        spawnedObjectMassInput.position = Vector2( { worldSettingsPanel.position.x - 86.0f, 145.0f + worldSettingsPanel.position.y } );
        ...
        DrawText("Spawned Object Radius: ", worldSettingsPanel.position.x - 86.0f, 175.0f + worldSettingsPanel.position.y, 12, GetColor(0xffffffff) );

        spawnedObjectRadiusInput.position = Vector2( { worldSettingsPanel.position.x - 86.0f, 190.0f + worldSettingsPanel.position.y } );
        ...
        deleteAllObjectButton.position = Vector2({ worldSettingsPanel.position.x - 86.0f, 230.0f + worldSettingsPanel.position.y });
        ...
        deleteAllJointsButton.position = Vector2({ worldSettingsPanel.position.x - 86.0f, 265.0f + worldSettingsPanel.position.y });
